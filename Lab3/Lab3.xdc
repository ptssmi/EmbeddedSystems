set_property PACKAGE_PIN U16 [get_ports {Light1[0]}]
...
set_property PACKAGE_PIN U19 [get_ports {Light1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Light1[2]}]
set_property PACKAGE_PIN W18 [get_ports {Light2[0]}]
set_property PACKAGE_PIN U15 [get_ports {Light2[1]}]
set_property PACKAGE_PIN U14 [get_ports {Light2[2]}]
...
set_property PACKAGE_PIN L1 [get_ports {state[0]}]
set_property PACKAGE_PIN P1 [get_ports {state[1]}]
set_property PACKAGE_PIN N3 [get_ports {state[2]}]
set_property PACKAGE_PIN P3 [get_ports {state[3]}]
